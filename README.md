...
```
```
curl -sL -o install_socks5.sh "https://raw.githubusercontent.com/Q303835/vps-tools/refs/heads/main/install_socks5.sh" && chmod +x install_socks5.sh && sudo ./install_socks5.sh && rm -f install_socks5.sh
```
